...
public class ChatGPTWidget {
    ...
    public static String chatGPT(String prompt) {
        ...
        try {
            ...
            HttpURLConnection connection = (HttpURLConnection) object.openConnection(); // Established a connection to
                                                                                        // the URL

            connection.setRequestMethod("POST"); // Specifies that I want to send (post) data to the server
            connection.setRequestProperty("Authorization", "Bearer " + apiKey); // The 'Authorization' Header is set
                                                                                // with the API key
    ...
    } // Parses a JSON response string and specifically extract the value associated
